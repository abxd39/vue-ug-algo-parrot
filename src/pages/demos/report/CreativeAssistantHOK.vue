...
const getEmbedLink = async () => {
    ...
    embed_link.value = "https://sg-tableau-new.intlgame.com/trusted/" + ticket.value + "/t/ComputerVisionAlgorithm/views/hokcreativeinsights/HOKCreativeInsights?:showAppBanner=false&:embed=yes"
